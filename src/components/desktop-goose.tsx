          ...
          <>
            ...
            <div
              ...
              onPointerMove={(e) => {
                ...
                const nx = clampGoosePos(
                  e.clientX - userDragRef.current.ox,
                  e.clientY - userDragRef.current.oy,
                );
                posRef.current = nx;
                setPos({ ...nx });
            ...
            >
              <div
                style={{
                  width: "100%",
                  height: "100%",
                  ...gooseSpriteLayerStyle(currentFrame, DISPLAY_SIZE),
                }}
              />
              {isChasing && (
                <div
                  className="absolute -top-6 left-1/2 -translate-x-1/2 font-pixel text-orange-500 text-[12px] font-bold animate-bounce"
                  style={{ transform: `scaleX(${facingRight ? -1 : 1}) translateX(-50%)` }}
                >
                  HONK!!
                </div>
              )}
