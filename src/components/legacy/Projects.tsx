              ...
              <ScopedSmoothScroll className="overflow-y-auto flex-1 pr-2 space-y-6 custom-scrollbar touch-pan-y pb-24 sm:pb-4">
                ...
                {openDrawer === "verdict" ? (
                  <>
                    ...
                    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
                      <h4 className="text-base sm:text-lg md:text-xl font-display font-bold text-white mb-4">
                        <i className="fas fa-bolt mr-2"></i>Core Features
                      </h4>
                      <ul className="space-y-3 text-[13px] sm:text-sm text-gray-300">
                        <li>
                          <strong className="text-white">Mirror Mode:</strong> Scrape and solve
                          Codeforces problems instantly.
                        </li>
                        <li>
                          <strong className="text-white">Smart IDE:</strong> Integrated Monaco
                          editor with multi-language support.
                        </li>
                        <li>
                          <strong className="text-white">Whiteboard Integration:</strong> Built-in
                          Excalidraw for visualizing algorithms.
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
                      <h4 className="text-base sm:text-lg md:text-xl font-display font-bold text-white mb-4">
                        <i className="fas fa-server mr-2"></i>Architecture
                      </h4>
                      <ul className="space-y-3 text-[13px] sm:text-sm text-gray-300">
                        <li>
                          <strong className="text-white">Browser Extension:</strong> Seamlessly
                          submit code from Verdict to external judges.
                        </li>
                        <li>
                          <strong className="text-white">Scraper Service:</strong> Dedicated
                          microservice for parsing problem statements.
                        </li>
                        <li>
                          <strong className="text-white">Dockerized:</strong> Fully containerized
                    ...
                    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
                      <h4 className="text-base sm:text-lg md:text-xl font-display font-bold text-white mb-4">
                        <i className="fas fa-layer-group mr-2"></i>Technologies
                      </h4>
                      <div className="flex flex-wrap gap-2">
                        {[
                          "Next.js 16",
