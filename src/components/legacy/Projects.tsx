  ...
  const projectsData = [
    {
      ...
      fullDescription: 'Solve Codeforces problems with a built-in IDE, Whiteboard, and Custom Judge—no more tab switching. Features Mirror Mode, Smart IDE, and Algorithm Visualization.',
            ...
            <div className="flex items-start justify-between mb-4 sm:mb-6 flex-shrink-0 gap-3">
                            ...
                            openDrawer === 'yousefdev' ? '/videos/yousefdev.webm' :
                              openDrawer === 'panoblue' ? '/videos/panoblue.webm' :
                                openDrawer === 'fazzah' ? '/videos/fazzah.webm' :
                                  openDrawer === 'verdict' ? '/videos/verdict.webm' : ''
                      }
                      autoPlay
                      loop
                      muted
              ...
              {openDrawer === 'verdict' ? (
                <>
                  ...
                  <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
                    <div className="flex flex-col gap-3">
                      <a href="https://verdict.run" target="_blank" rel="noopener noreferrer" className="w-full bg-white text-black hover:bg-gray-200 font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group">
                        <span>Visit Verdict.run</span>
                        <i className="fas fa-external-link-alt group-hover:translate-x-1 transition-transform"></i>
                      </a>
                      <a href="https://github.com/YUST777/verdict-community" target="_blank" rel="noopener noreferrer" className="w-full bg-white/10 text-white hover:bg-white/20 font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group border border-white/10">
