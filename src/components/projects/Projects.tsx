    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        <a
          ...
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full border border-white/20 px-4 sm:px-6 py-1.5 sm:py-2 text-[11px] sm:text-xs font-mono uppercase tracking-wider transition-colors hover:bg-white/10 text-zinc-300 hover:text-white self-start sm:self-auto"
        >
