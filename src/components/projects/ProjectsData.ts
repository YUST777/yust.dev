...
export const projectsData: Project[] = [
    ...
    features: [
      {
        ...
        svgIcon: "brain",
        items: ["90.64% R² Ensemble", "PyTorch Embeddings", "LightGBM & CatBoost"],
      },
      {
        category: "Floor-Plan Vision",
        svgIcon: "image",
        items: ["Gemini CAD OCR", "Interactive 2D/3D Konva", "Developer API Keys"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      {
        category: "Order Engine",
        svgIcon: "code",
        items: ["Non-Custodial", "Limit Orders", "Stop-Loss / Take-Profit", "TWAP Oracles"],
      },
      {
        category: "Terminal Features",
        svgIcon: "globe",
        items: ["Live AMM Depth", "AI Order Planning", "Cross-Chain Routes", "Onchain Proof"],
      },
      {
        category: "Contest Metrics",
        svgIcon: "trophy",
        items: ["Monad Mainnet", "Order Engine", "Limit & TWAP"],
      },
    ],
  },
  {
    ...
    repoLink: "https://github.com/YUST777/hellishgolf",
    siteLink: "https://hellishgolf.xyz",
    technologies: ["Phaser.js", "Rapier2D Physics", "Reddit Devvit CLI", "Supabase", "TypeScript"],
    drawerId: "hellishgolf",
    features: [
      {
