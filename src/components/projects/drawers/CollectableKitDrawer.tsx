...
function CollectableKitDrawer() {
  ...
  <>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <ul className="space-y-6 text-[13px] sm:text-sm text-gray-300">
        ...
        <li>
          ...
          Preparing cool profile stories used to take hours in Photoshop. Now? It's one click. Send
          any photo, add your watermark, and get shareable assets or ZIP files instantly.
        </li>
        <li>
          <strong className="text-white font-display block mb-1">
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <p className="text-[13px] sm:text-sm text-gray-300 leading-relaxed">
        I mastered the Telegram Mini App SDK and the complexities of TON rewards distributions. More
        importantly, I learned how to build for a niche community by identifying "high friction"
        manual tasks (like Photoshop editing) and automating them.
      </p>
    </div>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <p className="text-[13px] sm:text-sm text-gray-300 leading-relaxed italic border-l-2 border-white/20 pl-4 py-1">
        ...
        generate enough revenue through ads and premium plans to pay for its own servers. Turning a
        technical achievement into a self-sustaining ecosystem was a massive reality check in
        product management."
      </p>
    </div>
