  ...
  <>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <p className="text-[13px] sm:text-sm text-gray-300 leading-relaxed">
        ...
        high-quality hoodies and apparel. The client needed a rapid-deployment e-commerce solution to
        enter the market quickly without sacrificing quality.
      </p>
    </div>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <ul className="space-y-3 text-[13px] sm:text-sm text-gray-300">
        ...
        <li>
          <strong className="text-white">Logistics & Payments:</strong> Integrated a secure payment
          gateway and set up a backend warehouse management system to track inventory and orders.
        </li>
        <li>
