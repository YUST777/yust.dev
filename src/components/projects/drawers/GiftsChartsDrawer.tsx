  ...
  <>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <p className="text-[13px] sm:text-sm text-gray-300 leading-relaxed">
        Telegrams digital asset market is moving fast. <strong className="text-white">Gifts Charts</strong>{" "}
        bridges the gap between chaos and clarity by providing real-time price tracking for Stickers
        and unique Gifts. It empowers traders and collectors with instant data, helping them make
      ...
      <ul className="space-y-4 text-[13px] sm:text-sm text-gray-300">
        ...
        <li className="flex gap-3">
          ...
          <div>
            ...
            Includes a fully functional <strong>Premium Subscription</strong> system. Users can pay
            via Telegram Stars to unlock exclusive signals, "Goodies" tracking, and ad-free
            experiences.
          </div>
        </li>
      </ul>
