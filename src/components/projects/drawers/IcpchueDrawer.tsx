...
function IcpchueDrawer() {
  ...
  <>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <p className="text-[13px] sm:text-sm text-gray-300 leading-relaxed">
        You just join the Hub and immediately get the power of <strong className="text-white">Verdict.run</strong>{" "}
        integrated with a central 3D curriculum.
      </p>
    </div>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <ul className="space-y-3 text-[13px] sm:text-sm text-gray-300">
        ...
        <li>
          Presented at the Luxsai conference where <strong className="text-white">21 colleges</strong>{" "}
          liked the idea—it's now being adopted all over Egypt.
        </li>
      </ul>
    </div>
