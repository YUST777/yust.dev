  ...
  <>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <ul className="space-y-3 text-[13px] sm:text-sm text-gray-300">
        ...
        <li>
          <strong className="text-white">Window Management:</strong> Draggable and resizable windows
          that mimic old-school desktop environments.
        </li>
        <li>
          <strong className="text-white">Easter Eggs:</strong> Hidden commands and interactions that
