    ...
    <>
      ...
      <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
        ...
        <p className="text-[13px] sm:text-sm text-gray-300 leading-relaxed italic border-l-2 border-white/20 pl-4 py-1">
          "The hardest part was making the UI look truly premium and clean while linking everything
          to Supabase. I integrated MCP (Model Context Protocol) to create a 'real' and secure login
