  ...
  <>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <ul className="space-y-4 text-[13px] sm:text-sm text-gray-300">
        ...
        <li>
          <strong className="text-white">Full Compiler:</strong> Using Judge0 to test your solution
          before submitting to Codeforces.
        </li>
        <li>
          <strong className="text-white">Whiteboard Integrated:</strong> Fully integrated whiteboard
          using Excalidraw for visualizing algorithms.
        </li>
        <li>
          <strong className="text-white">Extension Submissions:</strong> Submit to Codeforces using
          our custom extension supported by scraping.
        </li>
        <li>
          <strong className="text-white">AI Teaching & Video Gen:</strong> Full AI features like MCP
          to teach you the problem + video generation to explain the problem using Remotion.
        </li>
        <li>
          <strong className="text-white">Analytics & History:</strong> Full analytics, history, and
          personal notes for every solve.
        </li>
      </ul>
    </div>
    ...
    <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-6">
      ...
      <p className="text-[13px] sm:text-sm text-gray-300 leading-relaxed italic">
        "Making the Verdict-to-Codeforces submission pipeline was insane. I built an extension that
        captures the user's Codeforces cookie and sends it to our backend. The backend then spins up
        a Server-Side Rendered Chromium engine via Playwright, opens a tab, signs in with the stolen
        cookie, navigates to the problem, chooses the language, submits the code, bypasses the
