...
function MainLayout() {
  ...
  return (
    <>
      <main className={`mx-auto pt-24 sm:pt-12 pb-16 sm:pb-40 min-h-[calc(100vh-[var(--footer-height)])] ${isProjects ? "px-0 w-full" : "max-w-5xl px-4 sm:px-6"}`}>
        <Outlet />
      </main>
      <footer className="max-w-5xl mx-auto pb-12 sm:pb-36 px-4 sm:px-6 text-xs text-zinc-600 flex justify-between font-mono">
        <div>
