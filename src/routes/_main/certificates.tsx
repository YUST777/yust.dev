...
function CertificateViewer({
  ...
  return (
    <aside className="flex flex-col items-center justify-start lg:translate-y-[35%] h-full w-full mt-2 sm:mt-4 lg:mt-0 pt-0" aria-label="Selected certificate preview">
      {/* 3D Scene Container */}
